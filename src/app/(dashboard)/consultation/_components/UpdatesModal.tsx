...
import { Updates } from "@/types/ConsultationPersonTypes";
...
export const UpdatesModal = ({ updates, onClose }: UpdatesModalProps) => {
        ...
        <div className="flex-1 overflow-auto">
          {updates && updates.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Publicação: {formatDateBR(update.PublishDate)}
                    </p>
                    <p className="text-sm text-gray-500">
                      Data de Captura: {formatDateBR(update.CaptureDate)}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="p-4 text-center text-gray-500">
              <p>Não contém nenhuma atualização cadastrada.</p>
            </div>
          )}
        </div>
      </section>
